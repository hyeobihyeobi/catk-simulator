...
export WOMD_VAL_PATH="${WAYMO_DATASET_PATH}/validation/validation_tfexample.tfrecord@150"
export WOMD_TRAIN_PATH="${WAYMO_DATASET_PATH}/training/training_tfexample.tfrecord@1000"
