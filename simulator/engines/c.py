...
class WaymoEnv():
    def __init__(self,
        ...
        p = Path("/home/jyyun/workshop/LatentDriver/WOMD/preprocessed_1to10/name.txt")
    ...
    def reset(self):
        ...
        # obs, obs_dict = None, None
        reference_lines = get_reference_line(cur_state)
        # target = get_agents_gt(cur_state)
        target = None
    ...
    def step(self,action=None, show_global=False):
        ...
        reference_lines = get_reference_line(current_state)
