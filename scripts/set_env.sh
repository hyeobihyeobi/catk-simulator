...
export WAYMO_DATASET_PATH="${WAYMO_DATASET_PATH:-/workspace/WOMD}"
export ROOT_PATH="${ROOT_PATH:-/workspace/catk-simulator}"
# export PRE_PROCESS_ROOT_PATH="/workspace/Git/LatentDriver"
export PRE_PROCESS_ROOT_PATH="${PRE_PROCESS_ROOT_PATH:-/workspace/catk-simulator}"
